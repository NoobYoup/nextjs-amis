...
export default function NewsUpdateClient({ id }: NewsUpdateClientProps) {
    ...
    useEffect(() => {
        const loadNews = async () => {
            try {
                const news = await api.get<News>(`/admin/news/${id}`);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await api.post(`/admin/news/${id}`, submitData);

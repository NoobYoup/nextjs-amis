...
class NewsController extends Controller {
    ...
    public function store() {
        ...
        try {
            ...
            foreach ($uploadedImages as $index => $url) {
                $imgSql = "INSERT INTO news_images (id, newsId, imageUrl, `order`) VALUES (:id, :newsId, :url, :order)";
                $imgStmt = $this->conn->prepare($imgSql);
    ...
    public function update($id) {
        ...
        try {
            ...
            // Handle Images
            // 1. Delete removed images if any (simplified: delete all and re-add for simplicity in this demo)
            // Ideally should check existingFiles from frontend
